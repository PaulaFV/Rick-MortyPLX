...
class CharactersListView: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private let configureUseCase = ConfigureUseCase(apiService: ApiCall())
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.injectUseCase(useCase: configureUseCase)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vcDetail = CharacterDetailView(character: selectedCharacter)
